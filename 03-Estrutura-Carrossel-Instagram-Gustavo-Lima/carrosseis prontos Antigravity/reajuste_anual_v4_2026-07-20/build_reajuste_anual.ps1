...
$templatePath = Join-Path $scriptDir 'template_reajuste_anual.html'
$outputPath   = Join-Path $scriptDir 'carrossel_reajuste_anual_v4.html'

$images = @{
    'COVER_B64_HERE' = 'capa_fatura_grafico_v3_1785758112643.jpg'
