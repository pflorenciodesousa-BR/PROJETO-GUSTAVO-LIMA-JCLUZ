...
$templatePath = Join-Path $scriptDir 'template_teste.html'
$outputPath = Join-Path $scriptDir 'carrossel_teste_v4.html'

$images = @{
    'IMG_REAL_HERE' = 'teste_imagem_real_hospital_1784035219985.png'
}
